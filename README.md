...
_**Feature Services:**_ These services are responsible for **interacting with the Flutter Deriv API**. Each service corresponds to a **specific feature or domain** within the app.
